...
public class ConsoleManager {
    public void interactive(String host, String p) throws IOException{
        ...
        invoker.register("print_unique_distance", new PrintUniqueDistance(receiver));
        invoker.register("exit", new Exit(receiver));
        invoker.register("print_field_ascending_distance", new PrintFieldAscendingDistance(receiver));
